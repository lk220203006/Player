...
@interface CusWatchViewController ()
{
    BOOL _played;
    NSString *_totalTime;
...
@implementation CusWatchViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    NSString *filename = [self.param objectForKey:@"filename"];
    self.navigationItem.title = filename;
    NSURL *videoUrl = [NSURL fileURLWithPath:[self.param objectForKey:@"filepath"]];
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    if ([self.stateButton.titleLabel.text isEqualToString:@"Stop"]) {
